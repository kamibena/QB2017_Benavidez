...
rm(list=ls())
getwd()
setwd("~/GitHub/QB2017_Benavidez/Week4-Spatial")
```
...
> For this portion of the assignment I have looked at SSADs for six speices during one year (2005) of our time series data.  I had to adjust the 'if' part of the loop compared to our homework activity as there were not many species in the dataset that met that criteria.  From the adjusted numbers is would seem as if there might be a small collection of abundant species, but most are rare.  There is definitely some differences in density probabilites between the species. 

![Image of SSADs for six random species in BCI during 2005](Rplot.tiff)
