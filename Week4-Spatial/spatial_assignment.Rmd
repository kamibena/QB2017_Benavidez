...
rm(list=ls())
getwd()
setwd("/Users/kamibena/GitHub/QB2017_Benavidez/Week4-Spatial")
```
...
install.packages(c("vegan", "sp", "gstat", "raster", "RgoogleMaps", "maptools", "rgdal", "simba", "gplots", "rgeos"))
require(c("vegan", "sp", "gstat", "raster", "RgoogleMaps", "maptools", "rgdal", "simba", "gplots", "rgeos"))
```
...
while(ct<4){
  ...
  if(length(ad)>10&sum(ad>100)){
    ct=ct+1
    plot(density(ad),col='red',xlab='Site Abundane',
