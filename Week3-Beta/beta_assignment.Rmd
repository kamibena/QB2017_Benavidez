...
> Answer 6***: Due to some environmental factor, some species of fish prefer and/or are limited to particular parts of the river.  Along the river gradient there seems to be four clusterings, with one clustering being particularly different.
...
doubs.env.cond.space=dbrda(fish.db ~ env.mod + Condition(space.mod)) doubs.space.cond.env=dbrda(fish.db ~ space.mod + Condition(env.mod))
