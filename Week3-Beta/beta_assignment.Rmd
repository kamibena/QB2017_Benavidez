...
> Answer 3a***: Alpha diversity  contributes a variety of diversity of several locations while beta turnover describes how this diversity changes from location to location.  Together these estimate describe gamma diversity, the diversity of the region which includes all possible locations.
...
> Ran a PCoA on 5/7 sites we plan to compare.  Two have some NA/NaN/Inf errors so we need to fix those matrices. Clustering was continuous and had a quadratic pattern.  For all year, PCoA 1 explained ~63% and PCoA 2 explained ~20%.  For this project we will need to learn how to analyze time series data.  