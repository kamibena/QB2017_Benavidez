...
> ***Answer 1b***:  When you have a larger number of evolutionary diversgent taxa in the communitiy, you will have high PD values.  When you have fewer divergent taxa, you will have few shared branches; therefore you will have lower PD values.                                       
> ***Answer 1c***:  Taxonomic rishness and and phyldivserity should deviate when....
...
> ***Answer 2a***:  The null model we are testing is richness, which is a randomized community matrix based on the sample pool - this model keeps constant the fequency of species occurences.  
> ***Answer 2b***:  
...
> ***Answer 4c***: XXX Mean pair distance show less variation because it is measuring averages between pairs of samples while unifrac is measuring distance ratios between pairs of samples.
