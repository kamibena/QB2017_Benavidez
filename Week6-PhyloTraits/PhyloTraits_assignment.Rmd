...
rm(list = ls())
getwd()
setwd("~/GitHub/QB2017_Benavidez/Week6-PhyloTraits")
...
> ***Answer 3***:  Advantages: This process analyzes a large number of sequences very quickly.  Disadvantages:  The algorithm used for star decomposition does not exhaust all the possibilities so likley does not give the more optimal solution (but it does give a good approximation).   
